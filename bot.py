...
target = "g0BNrb30de2e514d459a848bbba73124"

channell = "c0zJzy0e2c6e5793fd68f54ec777cda4"

chat = "u",""

bot.sendMessage(target,"موبو بات با موفقیت در گروه فعال شد 😍🕺")
...
message_id=msg.get("message_id"))
							...
							try:
								...
								bot.sendMessage(target, "کاربر {user} ارسال کلمات مستحجن در گروه ممنوع است❌", message_id=msg["message_id"])
							...
							try:
								...
								print("err poker answer")			 						
						elif msg.get("text") == "ربات" or msg.get("text") == "بات":
							try:
								user = bot.getUserInfo(msg["author_object_guid"])["data"]["user"]["first_name"]
